...
import Main.modele.Puissance4;
import Main.modele.IA;
...
public class Controleur {
    ...
    public void lancerJeu() {
        //initialisation des joueur avec l'utilisation de l'ihm
        ...
        //attribution des symboles au joueurs
    ...
    private void jouerMorpion() {
        ...
        while (!jeu.estFini()) {
            //récupere la grille actuel a l'aide de des classes dans modele et affichage avec ihm
            ...
            if (actuel.getNom().equals("IA")){
                ...
                coup= ia.choisirCoupMorpion(jeu,casesVides);
                ihm.afficherMessage("L'IA a joué: "+coup);
            }else{
                coup=ihm.saisirCoupMorpion(actuel.getNom());
            }
            //evite le crach si le joueur mes 1 seul valeur
            if (coup.length() < 2) {
    ...
    private void jouerPuissance4() {
        ...
        while (!jeu.estFini()) {
            ...
            if  (actuel.getNom().equals("IA")){
                ihm.afficherMessage("L'IA joue son coup");
                col= ia.choisirCoupPuissance4(jeu);
            }else{
    ...
    //affiche le résumé des victoires et détermine legagnant.
